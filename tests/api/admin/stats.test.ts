...
// Mock adminAuth completely - avoid NextAuth entirely
...
describe('/api/admin/stats', () => {
  ...
  describe('GET /api/admin/stats', () => {
    ...
    it('should return 401 for unauthenticated user', async () => {
      mockRequireAdminAuth.mockRejectedValue(new Error('Unauthorized - No session'))
    ...
    it('should return 403 for non-admin user', async () => {
      mockRequireAdminAuth.mockRejectedValue(new Error('Forbidden - Admin access required'))
    ...
    it('should handle database errors gracefully', async () => {
      // Simulate a database error after auth succeeds
      mockRequireAdminAuth.mockRejectedValue(new Error('Database connection failed'))
